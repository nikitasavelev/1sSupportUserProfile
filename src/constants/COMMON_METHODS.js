...
export function calculateAnalytics(operatorsAnalytics) {
  operatorsAnalytics.forEach(operator => {
    ...
    // averages
    statistics.averageCallsDuration = statistics.allCallsCount === 0 ?
                                      0 :
                                      statistics.averageCallsDuration / statistics.allCallsCount;
    statistics.averageOnlineTimePerDay = statistics.daysAmount - 1 === 0 ?
                                      0 :
                                      statistics.averageOnlineTimePerDay / (statistics.daysAmount - 1);
    statistics.averageMark = statistics.marksSum === 0 ?
                                      0 :
                                      statistics.averageMark / statistics.marksSum;
    assignVariables(
      operator,
      statistics
    );
